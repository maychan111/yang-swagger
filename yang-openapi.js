...
(function() {
  var Yang, debug, definitions, discoverOperations, discoverPathParameter, discoverPaths, discoverTags, patch, serializeJSchema, traverse, yaml, yang2jschema, yang2jsobj, yang2jstype;
      ...
      case !(refs != null ? refs.length : void 0):
        refs.forEach(function(ref) {
          if (definitions[ref.tag] == null) {
            ...
            return definitions[ref.tag] = yang2jsobj(schema.lookup('grouping', ref.tag));
          }
        });
  ...
  discoverOperations = function(schema, item) {
    var config, deprecated, origin, ref1, ref10, ref11, ref12, ref13, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, returnValue;
    if (item == null) {
      item = false;
    }
    config = ((ref1 = schema.config) != null ? ref1.tag : void 0) !== false;
    ...
    deprecated = ((ref2 = schema.status) != null ? ref2.valueOf() : void 0) === 'deprecated';
    returnValue = [];
    switch (false) {
      case (ref3 = schema.kind) !== 'rpc' && ref3 !== 'action':
        return {
          method: 'post',
          tags: [origin],
          ...
          parameter: {
            ...
            "in": 'body',
            description: (ref5 = schema.input) != null ? (ref6 = ref5.description) != null ? ref6.tag : void 0 : void 0,
        ...
        if (config && patch) {
          returnValue.push({
            ...
            parameter: {
              name: "" + schema.tag,
              "in": 'body',
              description: (ref13 = schema.description) != null ? ref13.tag : void 0,
              schema: yang2jschema(schema, item)
            },
            response: {
              code: 200,
  ...
  module.exports = require('./yang-openapi.yang').bind({
    transform: function(input) {
      ...
      modules = input.modules.map((function(_this) {
    ...
    '{specification}/serialize': function(input) {
      var ref1, spec;
      if (typeof debug === "function") {
